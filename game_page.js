...
function send()
{
    ...
    length_div2 = Math.floor(word.lenght/2);
    ...
    q_word = "<h4 id='word_display'>Q. " + r_charAt3 + "</h4>";
    in_box = "<br>Answer : <input type='text' id='input_check_box'>";
    check_button = "<br><br><button class='btn btn-info' onclick='check()'>Check</button>";
    row = q_word + in_box + check_button;
